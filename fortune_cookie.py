...
def create_fortune_cookie_message(how_many_lucky_numbers: int) -> str:
    ...
    lucky_nos = generate_lucky_numbers(how_many_lucky_numbers)

    return (lucky_nos, fortune)
...
def main():
    ...
    # print("Test message for fortune_cookie_message", fortune_cookie_message)
    print("\nHere is your fortune:\n")
    print(fortune_cookie_message[1])
